  ...
  return (
    <>
      <header className="sticky top-0 z-50 w-full border-b bg-white shadow-sm">
        ...
        {isMenuOpen && (
          <div className="fixed top-0 right-0 h-full w-64 bg-white z-50 md:hidden shadow-xl transform transition-transform duration-300 ease-in-out translate-x-0">
            <div className="flex flex-col h-full">
              ...
              {isAuthenticated && user && (
                <div className="px-4 py-4 border-b bg-gray-50">
                  ...
                  <div className="mt-2">
                    <span className="inline-block px-2 py-1 text-xs font-semibold rounded-full bg-white border border-gray-300 text-gray-800 capitalize">
                      {user.role}
                    </span>
                  </div>
                </div>
              ...
              <div className="p-4 border-t">
                {!isAuthenticated ? (
                  <Link to="/login" onClick={() => setIsMenuOpen(false)}>
                    <button className="group relative w-full flex items-center justify-center gap-2 px-5 py-3 bg-gradient-to-r from-blue-600 to-blue-700 hover:from-blue-700 hover:to-blue-800 text-white font-medium rounded-lg transition-all duration-300 shadow-md hover:shadow-lg active:scale-95 overflow-hidden">
                      <span className="absolute inset-0 bg-white opacity-0 group-hover:opacity-10 transition-opacity duration-300"></span>
                  ...
                  <button
                    ...
                    className="w-full bg-red-600 hover:bg-red-700 text-white font-medium rounded-lg transition-all duration-200 shadow-sm hover:shadow-md active:scale-95 flex items-center justify-center gap-2 px-4 py-2.5"
                  >
                    <LogOut className="h-4 w-4" />
                    Logout
                  </button>
      ...
      {/* Logout Confirmation Alert - No overlay, just the card */}
      {showLogoutConfirm && (
